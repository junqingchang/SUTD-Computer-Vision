...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        pooling_stride = 2
        D3 = D2
        W3 = int((W2 - pooling_size)/pooling_stride + 1)
        H3 = int((H2 - pooling_size)/pooling_stride + 1)
        
        self.params['W2'] = np.random.normal(0, weight_scale, (D3 * W3 * H3, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dx3, dw3, db3 = affine_backward(dout3, cache3)
